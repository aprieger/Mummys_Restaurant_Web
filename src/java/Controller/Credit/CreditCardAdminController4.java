...
This Controller will delete all the Credit Cards associated with a particular Customer_ID
*/
...
public class CreditCardAdminController4 extends SimpleFormController {

    public CreditCardAdminController4() {
    ...
    public ModelAndView onSubmit(Object command) throws Exception{
        ...
        //listOfCards = (ArrayList) 
                cc.deleteAllRecordsByUserId(card.getCUSTOMER_ID());
