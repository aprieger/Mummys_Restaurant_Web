        ...
        <form:form method="POST" commandName="worker"> 
          <table class="workerInfo"> 
            ...
            <tr>
                ...
                <form:input path="firstName" class="stretch" /></td> 
                
            </tr> 
            <tr> 
                <td>Last Name : <form:errors path="lastName" cssClass="error" />
                <form:input path="lastName" class="stretch" /></td> 
                
            </tr> 
            <tr> 
                <td>Gender : <form:select path="gender" class="stretch" >
            ...
            <tr> 
                ...
                <form:input path="phoneNumber" class="stretch" /></td> 
                
            </tr> 
            <tr> 
                <td>Is the employee an administrator?  No:0 Yes:1 :<form:input
                        type="number" min="0" max="1" path="isAdmin" class="stretch" /></td>
            </tr> 
            <tr> 
                <td>Is the employee active?  No:0 Yes:1 :<form:input
                        type="number" min="0" max="1" path="isActive" class="stretch" /></td>
            </tr> 
            <tr> 
                <td>
