    ...
    <body>
        ...
        <form:form method="POST" commandName="worker"> 
          <table class="workerInfo"> 
            ...
            <tr> 
                <td>
                    <form:input type="hidden" path="employeeId"  value="${worker.employeeId}" ></form:input>
                    <input type="submit" class="cssButton" name="edit" style="margin-left: 10px; margin-right: 90px">
